                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit.php?id=" . $row['id'] . " '><button class='btn btn-warning sm'>Edit</button></a>";
                                        echo "<a href='delete.php?id=" . $row['id'] . " >'onclick='return confirm(\"Yakin Hapus Data?\")'><button class='btn btn-danger sm'>Delete</button></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
